...
function buildObjectLayer(): TiledObject[] {
  ...
  add(
    makeObject(nextId++, 'Elevator to Floor 2', 'door', 37, 5, [
      ...
      prop('locked', 'true'),
      prop('requiresChallenge', 'ch03_08'),
    ]),
  );
